...
public class BookingConfirmation extends JPanel {
	...
	public BookingConfirmation(MainUI mainUI, BookingController bookingController) {
		...
		sl_panelBookingInfo.putConstraint(SpringLayout.NORTH, panelBookingInfoHeader, 0, SpringLayout.NORTH, panelBookingInfo);
		sl_panelBookingInfo.putConstraint(SpringLayout.WEST, panelBookingInfoHeader, 0, SpringLayout.WEST, panelBookingInfo);
		sl_panelBookingInfo.putConstraint(SpringLayout.SOUTH, panelBookingInfoHeader, 30, SpringLayout.NORTH, panelBookingInfo);
		sl_panelBookingInfo.putConstraint(SpringLayout.EAST, panelBookingInfoHeader, 0, SpringLayout.EAST, panelBookingInfo);
		...
		sl_panelBookingInfo.putConstraint(SpringLayout.NORTH, lblBookingNumber, 45, SpringLayout.NORTH, panelBookingInfo);
		sl_panelBookingInfo.putConstraint(SpringLayout.WEST, lblBookingNumber, 15, SpringLayout.WEST, panelBookingInfo);
		sl_panelBookingInfo.putConstraint(SpringLayout.EAST, lblBookingNumber, 130, SpringLayout.WEST, panelBookingInfo);
		...
		sl_panelBookingInfo.putConstraint(SpringLayout.NORTH, lblShootingRangeNumber, 15, SpringLayout.SOUTH, lblBookingNumber);
		sl_panelBookingInfo.putConstraint(SpringLayout.WEST, lblShootingRangeNumber, 15, SpringLayout.WEST, panelBookingInfo);
		sl_panelBookingInfo.putConstraint(SpringLayout.EAST, lblShootingRangeNumber, 130, SpringLayout.WEST, panelBookingInfo);
		...
		sl_panelBookingInfo.putConstraint(SpringLayout.NORTH, textFieldBookingNumber, 40, SpringLayout.NORTH, panelBookingInfo);
		...
		JLabel lblInstruktrNavn = new JLabel("Instruktør navn");
		sl_panelBookingInfo.putConstraint(SpringLayout.NORTH, lblInstruktrNavn, 17, SpringLayout.SOUTH, lblShootingRangeNumber);
		sl_panelBookingInfo.putConstraint(SpringLayout.WEST, lblInstruktrNavn, 0, SpringLayout.WEST, lblBookingNumber);
		lblInstruktrNavn.setFont(new Font("Tahoma", Font.PLAIN, 14));
		panelBookingInfo.add(lblInstruktrNavn);
		
		JLabel lblVben = new JLabel("Våben");
		sl_panelBookingInfo.putConstraint(SpringLayout.NORTH, lblVben, 18, SpringLayout.SOUTH, lblInstruktrNavn);
		sl_panelBookingInfo.putConstraint(SpringLayout.WEST, lblVben, 0, SpringLayout.WEST, lblBookingNumber);
		lblVben.setFont(new Font("Tahoma", Font.PLAIN, 14));
		panelBookingInfo.add(lblVben);
		...
		sl_panelCustomerInfo.putConstraint(SpringLayout.NORTH, panelCustomerInfoHeader, 0, SpringLayout.NORTH, panelCustomerInfo);
		sl_panelCustomerInfo.putConstraint(SpringLayout.WEST, panelCustomerInfoHeader, 0, SpringLayout.WEST, panelCustomerInfo);
		sl_panelCustomerInfo.putConstraint(SpringLayout.SOUTH, panelCustomerInfoHeader, 30, SpringLayout.NORTH, panelCustomerInfo);
		sl_panelCustomerInfo.putConstraint(SpringLayout.EAST, panelCustomerInfoHeader, 0, SpringLayout.EAST, panelCustomerInfo);
		...
		sl_panelCustomerInfo.putConstraint(SpringLayout.NORTH, lblCustomerName, 45, SpringLayout.NORTH, panelCustomerInfo);
		sl_panelCustomerInfo.putConstraint(SpringLayout.WEST, lblCustomerName, 15, SpringLayout.WEST, panelCustomerInfo);
		sl_panelCustomerInfo.putConstraint(SpringLayout.EAST, lblCustomerName, 130, SpringLayout.WEST, panelCustomerInfo);
		lblCustomerName.setFont(new Font("Tahoma", Font.PLAIN, 14));
		panelCustomerInfo.add(lblCustomerName);
		
		textFieldCustomerName = new JTextField();
		sl_panelCustomerInfo.putConstraint(SpringLayout.NORTH, textFieldCustomerName, 40, SpringLayout.NORTH, panelCustomerInfo);
		...
		sl_panelCustomerInfo.putConstraint(SpringLayout.NORTH, lblCustomerPhone, 15, SpringLayout.SOUTH, lblCustomerName);
		sl_panelCustomerInfo.putConstraint(SpringLayout.WEST, lblCustomerPhone, 15, SpringLayout.WEST, panelCustomerInfo);
		...
		sl_panelCustomerInfo.putConstraint(SpringLayout.NORTH, lblCustomerEmail, 15, SpringLayout.SOUTH, lblCustomerPhone);
		sl_panelCustomerInfo.putConstraint(SpringLayout.WEST, lblCustomerEmail, 15, SpringLayout.WEST, panelCustomerInfo);
		...
		sl_panelBookingRessources.putConstraint(SpringLayout.NORTH, panelRessourcesHeader, 0, SpringLayout.NORTH, panelBookingRessources);
		sl_panelBookingRessources.putConstraint(SpringLayout.WEST, panelRessourcesHeader, 0, SpringLayout.WEST, panelBookingRessources);
		sl_panelBookingRessources.putConstraint(SpringLayout.SOUTH, panelRessourcesHeader, 30, SpringLayout.NORTH, panelBookingRessources);
		sl_panelBookingRessources.putConstraint(SpringLayout.EAST, panelRessourcesHeader, 0, SpringLayout.EAST, panelBookingRessources);
		...
		sl_panelBookingRessources.putConstraint(SpringLayout.NORTH, txtFieldRessourceName, 45, SpringLayout.NORTH, panelBookingRessources);
		sl_panelBookingRessources.putConstraint(SpringLayout.WEST, txtFieldRessourceName, 15, SpringLayout.WEST, panelBookingRessources);
		sl_panelBookingRessources.putConstraint(SpringLayout.EAST, txtFieldRessourceName, -100, SpringLayout.EAST, panelBookingRessources);
		...
		sl_panelBookingRessources.putConstraint(SpringLayout.WEST, txtFieldPrice, 0, SpringLayout.EAST, txtFieldRessourceName);
		txtFieldPrice.setRequestFocusEnabled(false);
		sl_panelBookingRessources.putConstraint(SpringLayout.NORTH, txtFieldPrice, 45, SpringLayout.NORTH, panelBookingRessources);
		sl_panelBookingRessources.putConstraint(SpringLayout.EAST, txtFieldPrice, -15, SpringLayout.EAST, panelBookingRessources);
		...
		sl_panelBookingRessources.putConstraint(SpringLayout.NORTH, txtFieldShootingRange, 5, SpringLayout.SOUTH, txtFieldRessourceName);
		txtFieldShootingRange.setRequestFocusEnabled(false);
		sl_panelBookingRessources.putConstraint(SpringLayout.WEST, txtFieldShootingRange, 15, SpringLayout.WEST, panelBookingRessources);
		sl_panelBookingRessources.putConstraint(SpringLayout.EAST, txtFieldShootingRange, -100, SpringLayout.EAST, panelBookingRessources);
		...
		sl_panelBookingRessources.putConstraint(SpringLayout.NORTH, txtFieldShootingRangePrice, 5, SpringLayout.SOUTH, txtFieldPrice);
		sl_panelBookingRessources.putConstraint(SpringLayout.WEST, txtFieldShootingRangePrice, 0, SpringLayout.EAST, txtFieldShootingRange);
		txtFieldShootingRangePrice.setRequestFocusEnabled(false);
		sl_panelBookingRessources.putConstraint(SpringLayout.EAST, txtFieldShootingRangePrice, -15, SpringLayout.EAST, panelBookingRessources);
		...
		sl_panelBookingRessources.putConstraint(SpringLayout.NORTH, textFieldInstructor, 5, SpringLayout.SOUTH, txtFieldShootingRange);
		...
		sl_panelBookingRessources.putConstraint(SpringLayout.NORTH, textFieldWeapon, 5, SpringLayout.SOUTH, textFieldInstructor);
		...
		sl_panelBookingRessources.putConstraint(SpringLayout.NORTH, textFieldTotal, 5, SpringLayout.SOUTH, textFieldWeapon);
		textFieldTotal.setRequestFocusEnabled(false);
		sl_panelBookingRessources.putConstraint(SpringLayout.WEST, textFieldTotal, 15, SpringLayout.WEST, panelBookingRessources);
		sl_panelBookingRessources.putConstraint(SpringLayout.EAST, textFieldTotal, -100, SpringLayout.EAST, panelBookingRessources);
		...
		sl_panelBookingRessources.putConstraint(SpringLayout.NORTH, textFieldInstructorPrice, 5, SpringLayout.SOUTH, txtFieldShootingRangePrice);
		sl_panelBookingRessources.putConstraint(SpringLayout.WEST, textFieldInstructorPrice, 0, SpringLayout.EAST, textFieldInstructor);
		textFieldInstructorPrice.setRequestFocusEnabled(false);
		sl_panelBookingRessources.putConstraint(SpringLayout.EAST, textFieldInstructorPrice, -15, SpringLayout.EAST, panelBookingRessources);
		...
		sl_panelBookingRessources.putConstraint(SpringLayout.NORTH, textFieldWeaponPrice, 5, SpringLayout.SOUTH, textFieldInstructorPrice);
		sl_panelBookingRessources.putConstraint(SpringLayout.WEST, textFieldWeaponPrice, 0, SpringLayout.EAST, textFieldWeapon);
		textFieldWeaponPrice.setRequestFocusEnabled(false);
		sl_panelBookingRessources.putConstraint(SpringLayout.EAST, textFieldWeaponPrice, -15, SpringLayout.EAST, panelBookingRessources);
		...
		sl_panelBookingRessources.putConstraint(SpringLayout.NORTH, textFieldTotalPrice, 5, SpringLayout.SOUTH, textFieldWeaponPrice);
		sl_panelBookingRessources.putConstraint(SpringLayout.WEST, textFieldTotalPrice, 0, SpringLayout.EAST, textFieldTotal);
		textFieldTotalPrice.setRequestFocusEnabled(false);
		sl_panelBookingRessources.putConstraint(SpringLayout.EAST, textFieldTotalPrice, -15, SpringLayout.EAST, panelBookingRessources);
